...
#define ADDRESS_CELL_H 60

#define CONTACT_CELL_H 67
#define CELL_IMG_SIZE_W 50
#define CELL_IMG_SIZE_H 50


#define CELL_LABEL_MAX_W  180           //聊天内容labble的大宽度

#define GROUPNOTICE_CELL_H 90
...
//bubble想关间距
#define CELL_BUBBLE_ARROW_W    9      //bubble箭头的宽度
#define CELL_BUBBLE_TOP_MARGIN 10       //bubble内部内容与bubble边界的上边距
#define CELL_BUBBLE_BOTTOM_MARGIN 10    //bubble内部内容与bubble边界的下边距
...
#define CELL_AUDIO_TOP_H (CELL_IMG_SIZE_W - CELL_AUDIO_MIN_W)/2 //和头像高度差

#define CELL_PIC_THUMB_MAX_H 160.f            //聊天图片缩约图最大高度
#define CELL_PIC_THUMB_MAX_W 160.f            //聊天图片缩约图最大宽度
...
#define CELL_LOCATION_DESC_LABEL_H 30 //位置label高
#define CELL_LOCATION_IMAGE_W 200//位置label宽
#define CELL_LOCATION_IMAGE_H 80//位置label高


//chat list cell
#define CELLLIST_EAGE_LEFT_PADDING 15
#define CELLLIST_HEADIMAGE_WEITH 40
#define CELLLIST_HEADIMAGE_NAME_PADDING 25
#define CELLLIST_NAME_IDENTIFY_PADDING 14


//chat list cell
#define CELLGROUP_LABEL_HEIGHT 30
