...
/** Category of additions for `<WildIMKitDatabase>` class.
...
@interface WildIMKitDatabase (WildIMKitDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `WildIMKitDatabaseAdditionsVariadic.swift` in your project.
 */
