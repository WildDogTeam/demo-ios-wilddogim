...
@class WildIMKitStatement;

/** Represents the results of executing a query on an `<WildIMKitDatabase>`.
...
@interface WildIMKitResultSet : NSObject {
    WildIMKitDatabase          *_parentDB;
    WildIMKitStatement         *_statement;
...
/** `WildIMKitStatement` used by result set. */

@property (atomic, retain) WildIMKitStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<WildIMKitStatement>`
 
 @param statement A `<WildIMKitStatement>` to be performed
